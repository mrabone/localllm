...
def _make_mock_conn():
    ...
    Note: an identical copy exists in common/tests/test_session_store.py.  Cross-package
...
class TestShouldExtractMemories:
    def test_user_messages_should_be_extracted(self):
        assert should_extract_memories("user") is True

    def test_assistant_messages_should_not_be_extracted(self):
        assert should_extract_memories("assistant") is False

    def test_system_messages_should_not_be_extracted(self):
        assert should_extract_memories("system") is False
